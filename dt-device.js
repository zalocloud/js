...
function showPosition(position) {
    ...
    document.getElementById('list4').textContent += "Latitude: " + latitude + ", Longitude: " + longitude;
}

function showError(error) {
    document.getElementById('list4').textContent += "Location information is unavailable.";
}

if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(showPosition, showError);
} else {
    document.getElementById('list4').textContent += "Geolocation is not supported by this browser.";
}
